...
// Walks through our level data, gets the tile that's there,
// if it's zero, draw nothing, if there is a tile, get the UV coords
// and build the list of vertices, get the texture coordinates, and save the 
// size of our map
void Map::Build()
{
...
// Is there a tile at this position and how much is there inside of that tile
